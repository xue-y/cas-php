...
return [
    ...
    "login_out"=>"退出登录", 
    // 图片上传
    "file_up_empty"=>"您没有上传文件/图片",
    "file_size_max"=>"您上传的文件/图片大于 %d MB",
    "file_up_error_1"=>"超过php.ini允许的大小。",
    "file_up_error_2"=>"超过表单允许的大小。",
    "file_up_error_3"=>"图片只有部分被上传。",
    "file_up_error_4"=>"请选择文件/图片。",
    "file_up_error_6"=>"找不到临时目录。",
    "file_up_error_7"=>"写文件到硬盘出错。",
    "file_up_error_8"=>"禁止上传的文件扩展名。",
    "file_up_error_9"=>"未知错误。",
    "file_mime_error"=>"不支持上传的类型",
    "file_up_url_empty"=>"文件上传路径不得为空",
    "file_del_url_empty"=>"文件删除路径不得为空"
];