...
function(e) {
    ...
    I.prototype.config = {
        ...
        loading: !0,
        cellMinWidth: 60,
      //  operateToolbar:['add','update','delete'],
    ...
    I.prototype.renderToolbar = function() {
        ...
        var l_html=l.join("");
        if ("default" === a.toolbar) n.html(l_html);
        else if ("string" == typeof a.toolbar) {
            var o = t(a.toolbar).html() || "";
            o && n.html(i(o).render(a))
        } else if(a.operateToolbar){
            var operate='';
            "object" == typeof a.operateToolbar && "default" !== a.toolbar  && layui.each(a.operateToolbar,
            function(e, t) {
               if(t=='add'){
                    operate+=l[0];
               }else if(t=='update'){
