...
INSERT INTO `cas_admin_auth` VALUES
(1,'','admin','管理员管理','','',0,'fa-circle-o',1,1,2,1,0),(2,'','back','后台管理','','',0,'fa-home',1,1,1,1,1),
(3,'','sys','配置管理','','',0,'fa-circle-o',1,1,6,1,0),(4,'','log','日志管理','','',0,'fa-book',1,1,7,1,0),
